...
#For each site-phenophase combination: how many years are individuals re-measured?
...
#For each PFT-phenophase combination: Does the Standard Deviation in DOYs and lengths between phenophases differ between EcM and AM associated plants acrross all sites and within each site?
...
#Lengths Between Phenophases:

  
```


#For each PFT-phenophase combination: Does the DOY of the timing and the lengths between phenophases differ between EcM and AM assocated plants across all sites and within each site?
