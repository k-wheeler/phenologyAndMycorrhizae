...
for(funName in c("mean","max","min")){
  calculateDailyWeather(dataName=dataName,dataPath=dataPath,varName=varName,funType=mean,funName=funName)
  #Calculate LRs
  gapFillFromDayMet_verticalProfiles(dataName=dataName,dataPath=dataPath,varName=varName,funName=funName)
}
