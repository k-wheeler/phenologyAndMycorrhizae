...
for(continent in c('europe','USA')){
  ...
  write.csv(allCDD_spring,file=paste0("allCDD_spring_",continent,".csv"))
  write.csv(allGDD_spring,file=paste0("allGDD_spring_",continent,".csv"))
  
  write.csv(allCDD_fall,file=paste0("allCDD_fall_",continent,".csv"))
  write.csv(allGDD_fall,file=paste0("allGDD_fall_",continent,".csv"))
  
  write.csv(allDayLengths_spring,file=paste0("allDayLengths_spring_",continent,".csv"))
  write.csv(allDayLengths_fall,file=paste0("allDayLengths_fall_",continent,".csv"))
  
  write.csv(allCumP_spring,file=paste0("allCumP_spring_",continent,".csv"))
  write.csv(allCumP_fall,file=paste0("allCumP_fall_",continent,".csv"))
  
  write.csv(allFrostStatus_spring,file=paste0("allFrostStatus_spring_",continent,".csv"))
  write.csv(allFrostStatus_fall,file=paste0("allFrostStatus_fall_",continent,".csv"))
}
